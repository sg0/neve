...
maxOrder_(0), nv_per_batch_(0)
{
    ...
    std::cout << nv_per_batch_ << std::endl;
    CudaMalloc(edges_,       unit_size*nv_per_batch_*maxOrder_);
    CudaMalloc(edgeWeights_, unit_size*nv_per_batch_*maxOrder_);
    CudaMalloc(commIdKeys_,  sizeof(GraphElem2)*nv_per_batch_*maxOrder_);

    indexOrdersHost_ = new GraphElem [nv_per_batch_*maxOrder_];
...
)
{
    ...
    GraphElem nv_per_batch = (GraphElem)(free_m / unit_size / 8. / maxOrder * 1048576.0);
...
void GraphGPU::sort_edges_by_community_ids()
{
    ...
    thrust::device_ptr<GraphElem>  vals_ptr = thrust::device_pointer_cast(edgeWeights_);
    ...
    { 
        ...
        CudaMemcpyAsyncHtoD((GraphElem*)edges_, edgesHost_+e0, sizeof(GraphElem)*ne, cuStreams[0]);
        ...
        thrust::stable_sort_by_key(keys_ptr, keys_ptr+ne, vals_ptr, less_int2());
        ...
        CudaMemcpyAsyncHtoD(edges_, indexOrdersHost_, sizeof(GraphElem)*ne, cuStreams[1]);
